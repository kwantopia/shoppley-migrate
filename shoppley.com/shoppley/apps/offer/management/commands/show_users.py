...
class Command(NoArgsCommand):
	...
	def handle_noargs(self, **options):
		...
		for u in ShoppleyUser.objects.all():
			if u.is_customer():
				print u.id, u.user.email, u.phone, u.is_merchant(), u.verified, u.customer.offer_count, u.customer.daily_limit
			else:
				print u.id, u.user.email, u.phone, u.is_merchant(), u.verified 
