...
class TxtTemplates:
	templates = {
		"MERCHANT": {
			...
			"OFFER_NO_CUSTOMER" : "There were no customers that could be reached at this moment. Txt #status %s to track this offer.",
			...
			"STATUS_SUCCESS": "[%(code)s] Offer: {{ offer }} [sent to {{ sentto }}], [forwarded to {{ forwarded }}], [redeemed by {{ redeemer }} Txt #status %(code)s to track the offer",
