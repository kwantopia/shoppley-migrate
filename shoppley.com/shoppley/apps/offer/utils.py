...
,
			...
			"SIGNUP_SUCCESS": "Sign up successful! Please use this info to log in. Username: {{ email }}; password: {{ password }}. Txt #help for all commands.",# Currently, {{ number }} stores are signed up in your area. Tell your favorite stores to use Shoppley to send you any last minute offers for free. Txt #help for all commands, #stop to stop receiving msgs from us.",
			"SIGNUP_SUCCESS_NO_PASSWORD": "Sign up successful! You can use Username: {{ email }} to log in with your password. Txt #help for all commands.", #Currently, {{ number }} stores are signed up in your area. Tell your favorite stores to use Shoppley to send you any last minute offers for free. Txt #help for all commands, #stop to stop receiving msgs from us.",  
