from shoppleyuser.models import Merchant
#from haystack.query import SearchQuerySet
from django.forms import MultiValueField, CharField, ChoiceField
from django.forms.extras.widgets import SelectDateWidget
from django.forms.widgets import Widget, Select, MultiWidget, TextInput
...
class InputAndChoiceWidget(MultiWidget):
    def __init__(self, attrs=None):
	choices = [('$','$'), ('%','%'), ('custom', 'custom')]
        widget = (TextInput(attrs={'value':'0'}),
...
class InputAndChoiceField(MultiValueField):
...
#        sqs = SearchQuerySet().models(Merchant)
