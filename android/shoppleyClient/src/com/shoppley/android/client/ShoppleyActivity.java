 ...
 * between the tabs.
 */
public class ShoppleyActivity extends FragmentActivity {

	ShoppleyFragment shoppleyFragment;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		shoppleyFragment = new ShoppleyFragment();
		...
		// mTabsAdapter.addTab(mTabHost.newTabSpec("current").setIndicator("Current CurrentOffers",
		// getResources().getDrawable(R.drawable.tab_current_offers)),
		// CurrentListFragment.class, null);
		// mTabsAdapter.addTab(mTabHost.newTabSpec("redeemed").setIndicator("Redeemed CurrentOffers",
	...
	protected void onResume() {
		((ShoppleyApplication) getApplication()).requestLocationUpdate();
		super.onResume();
	}

	protected void onPause() {
		super.onPause();
		((ShoppleyApplication) getApplication()).removeLocationUpdate();
	};
}
