 ...
 * between the tabs.
 */
public class ShoppleyFragment extends Fragment {
	TabHost mTabHost;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mTabsAdapter.addTab(
				mTabHost.newTabSpec("current").setIndicator(
						"Current Offers",
						getResources().getDrawable(
								R.drawable.tab_current_offers)),
				CurrentListFragment.class, null);
		mTabsAdapter.addTab(
				mTabHost.newTabSpec("redeemed").setIndicator(
						"Redeemed Offers",
						getResources().getDrawable(
								R.drawable.tab_redeemed_offers)),
	...
	public static class TabsAdapter extends FragmentPagerAdapter implements
		...
		public Fragment getItem(int position) {
			...
			Fragment instance = Fragment.instantiate(mContext, info.clss.getName(),
					info.args);
			return instance;
		}
