...
import com.shoppley.android.api.merchant.ActiveResponse;
...
public class ActiveListFragment extends ListFragment implements
	...
	public static class CurrentListAdapter extends ArrayAdapter<Offer> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				view = mInflater.inflate(R.layout.active_list_item, parent,
						false);
			} else {
				view = convertView;
			}
...
//	}
	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		...
		ft.add(R.id.simple_fragment, new ActiveFragment(item));
		...
		return new OfferListLoader<Offer>(getActivity(),
				new OfferListLoader.Callback<Offer>() {
					public List<Offer> execute() {
						...
						ActiveResponse offer = null;
						offer = api.merchantGetActiveOffers();
